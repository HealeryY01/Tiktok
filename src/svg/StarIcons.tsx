...
export const StarIcon: React.FC<StarSvgProps> = ({
  width = "14",
  height = "13",
  color = "currentColor",
}) => {
...
export const StarIconTwo: React.FC<StarSvgProps> = ({
  width = "16",
  height = "15",
  color = "currentColor",
}) => {
...
export const StarIconFour: React.FC<SvgProps> = ({
  width = "18",
  height = "17",
}) => {
  return (
