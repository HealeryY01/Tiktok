...
export const ArrowSvg: React.FC<ArrowSvgProps> = ({
  ...
  strokeWidth = "1.5",
  viewBox = "0 0 10 10",
  pathValue = "M1 9L9 1M9 1H1M9 1V9",
}) => {
  return (
    <>
      <svg
...
export const ArrowTwo: React.FC<ArrowSvgProps> = ({
  width = "102",
  height = "9",
  viewBox = "0 0 102 9",
...
export const ArrowFour: React.FC<ArrowSvgProps> = ({
  width = "12",
  height = "12",
  viewBox = "0 0 12 12",
...
export const ArrowThirteen: React.FC<SvgProps> = ({
  width = "14",
  height = "14",
  viewBox = "0 0 14 14",
  pathValue = "M1 7H13",
  pathValueTwo = "M7 1L13 7L7 13",
}) => {
  return (
    <>
      <svg
...
export const ArrowNextPrevIcon = ({
  direction = "right",
  strokeColor = "white",
}) => (
  <svg
    ...
    <>
      ...
      >
        ...
        <path
          d={
            direction === "right"
              ? "M4 7.98173L0.5 4.4999L4 1.01807"
              : "M97 7.98173L100.5 4.4999L97 1.01807"
          }
          stroke="#111013"
          strokeLinecap="round"
          strokeLinejoin="round"
