        ...
        <div className="container container-1230">
          <div className="cr-footer-border-wrap pt-140 ">
            <div className="cr-footer-inner-warp z-index-1">
              <div className="row">
                <div
                  className="col-xl-4 col-lg-4 col-md-6 mb-40 tp_fade_anim"
                  data-delay=".3"
                >
                  <div className="dgm-footer-widget cr-footer-col-1 z-index-1">
                    <div className="dgm-footer-logo mb-20">
                      <Link href="/">
                        <Image width={120} src={logoWhite} alt="logo white" />
                      </Link>
                    </div>
                ...
                <div
                  className="col-xl-3 col-lg-4 col-md-3 mb-40 tp_fade_anim"
                  data-delay=".5"
                >
                  ...
                  <div className="dgm-footer-widget app-footer-widget cr-footer-col-3">
                    ...
                    <div className="dgm-footer-widget-menu">
                      <ul>
                        ...
                        <li>
                          <Link href="#">HR Partner Program</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div
                  className="col-xl-2 col-lg-3 col-md-3 mb-40 tp_fade_anim"
                  data-delay=".9"
                >
                  <div className="dgm-footer-widget app-footer-widget cr-footer-col-4">
                    ...
                    <div className="app-footer-widget-info mb-20">
                      <div className="app-footer-widget-info-title">
                        Call us directly?
                      </div>
                      <Link className="tp-line-white" href="tel:123456789">
                        (+123) 567 8910
                      </Link>
                    </div>
