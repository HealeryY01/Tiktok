...
const AboutService: React.FC = () => {
  ...
  return (
    <div
      id="down"
      className="pp-about-me-service-area pp-about-me-service-ptb z-index-3 p-relative pb-170"
    >
              ...
              <div className="pp-skill-list-wrap pp-about-me-skill">
                <div className="row">
                  {skills.map((skill, index) => (
                    <div
                      key={index}
                      className="col-sm-6 tp_fade_anim"
                ...
                <div className="row row-cols-xl-3 gx-20">
                  {tools.map((tool, index) => (
                    <div key={index} className="col">
                      <div
                        className="pp-about-me-tool-item d-flex align-items-center mb-20 tp_fade_anim"
                        data-delay={`.${3 + (index % 3) * 2}`}
                      >
                        <div className="pp-about-me-tool-item-icon">
                          <span>
                            <Image src={tool.icon} alt="" />
                          </span>
                        </div>
                ...
                <div className="row">
                  {experiences.map((exp, index) => (
                    <div key={index} className="col-sm-6">
                      <div
                        className="pp-about-me-experience-item pb-75 tp_fade_anim"
                        data-delay={index % 2 === 0 ? ".3" : ".5"}
                      >
                        <p>{exp.period}</p>
                        <h4 className="pp-about-me-experience-title">
                          {exp.title}
                        </h4>
                        <p>{exp.company}</p>
                      </div>
