            ...
            <div className="col-lg-4">
              <div className="cr-testimonial-wrap pt-40 pl-50">
                <div className="cr-testimonial-content">
                  <span>
                    4.8
                    <StarIconTwo width={18} height={18} color="#F9A811" />
                  </span>
                  <p>86+ reviews</p>
                </div>
                <h3 className="cr-testimonial-title">
                    ...
                    <SwiperSlide key={testimonial.id}>
                      <div className="cr-testimonial-item z-index-1 text-center">
                        <div className="cr-testimonial-item-top pb-40">
                          <p className="cr-testimonial-item-subtitle">
                            {testimonial.reviewedOn}
                          </p>
                          {testimonial.logo && (
                            <Image src={testimonial.logo} alt="company logo" />
                          )}
                        </div>
                        <h3 className="cr-testimonial-item-title">
                          {testimonial.quote}
                        </h3>
