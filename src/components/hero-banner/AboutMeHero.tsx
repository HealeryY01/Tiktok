import aboutThumb from "../../../public/assets/img/about-me/about-me-thumb-1.jpg";
...
const AboutMeHero: React.FC = () => {
  return (
    <div
      className="pp-about-me-area pp-about-me-ptb z-index-1"
      style={{ backgroundColor: "#2F1F19" }}
    >
      <div className="container-fluid">
        <div className="pp-about-me-heading text-center z-index-1 d-none d-md-block">
          <h4 className="pp-about-me-title tp-char-animation">Về chúng tôi</h4>
        </div>
            ...
            <div className="swiper-wrapper slide-transtion">
              {[...Array(5)].map((_, index) => (
                <div className="swiper-slide" key={index}>
                  <h4 className="pp-about-me-title">Về chúng tôi</h4>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="col-xl-4 col-lg-4 col-md-12">
            <div className="pp-hero-left z-index-1">
              <div className="pp-about-me-hero-left pt-90 pb-100 z-index-1">
                ...
                <span className="pp-hero-text tp-split-text tp-split-right">
                  Đội ngũ phát <br />
                  triển đầy <br />
                  đam mê
                </span>
                <p>Sẵn sàng nhận việc</p>
              </div>
            </div>
          </div>
