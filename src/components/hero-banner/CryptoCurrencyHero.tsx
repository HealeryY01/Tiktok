...
const CryptoCurrencyHero = () => {
  return (
    <div
      className="cr-hero-area fix cr-hero-ptb p-relative pt-170"
    ...
    >
      ...
      <div className="cr-hero-left">
        <div
          className="shape-1 tp_fade_anim"
          data-fade-from="left"
          data-delay=".5"
        >
          <Image src={shape1} alt="hero-shape" />
        </div>
        <div
          className="shape-2 tp_fade_anim"
          data-fade-from="left"
          data-delay=".5"
        >
          <Image src={shape2} alt="hero-shape" />
        </div>
      </div>
      <div className="cr-hero-right">
        <div
          ...
          data-delay=".5"
        >
          <Image src={shape3} alt="hero-shape" />
        </div>
        <div
          className="shape-2 tp_fade_anim"
          data-fade-from="right"
          data-delay=".5"
        >
          <Image src={shape4} alt="hero-shape" />
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="cr-hero-heading text-center z-index-1">
              ...
              <h4
                className="tp-section-title-onest fs-72 tp-text-revel-anim"
                data-delay=".5"
              >
                Chuyển đổi doanh nghiệp của bạn <br />
                với bộ giải pháp toàn diện của TikCRM
              </h4>
            </div>
            <div className="cr-hero-content text-center z-index-2">
              <div className="tp_text_anim">
                <p>Bộ giải pháp toàn diện cho seller TikTok Shop</p>
              </div>
