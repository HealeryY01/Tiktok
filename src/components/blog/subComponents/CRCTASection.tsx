          ...
          <div className="col-lg-12">
            <div className="cr-cta-content text-center">
              ...
              <h4 className="tp-section-title-onest fs-50 tp-text-revel-anim">
                Unlock your full trading <br /> potential with industry-leading
                tools.
              </h4>
              <div className="tp_text_anim">
                <p className="cr-cta-text">
                  Trade, invest, and manage your cryptocurrency portfolio with
                  precision and ease
                </p>
              </div>
              <div
                className="cr-cta-btn tp_fade_anim"
                data-delay=".7"
                data-fade-from="top"
                data-ease="bounce"
              >
