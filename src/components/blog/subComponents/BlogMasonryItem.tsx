...
const blogData: BlogPost[] = [
  // Type 1: Standard blog post with image
  {
    ...
    excerpt:
      "Learn about the intricate process of 3D modeling and how it transforms ideas into digital reality.",
    videoId: null,
  },
  // Type 2: Text-only blog post
  {
    ...
    excerpt:
      "Explore how social media platforms have become powerful tools that influence cultural norms and societal values.",
  },
  // Type 3: Video blog post
  {
    ...
    excerpt:
      "Discover practical tips to improve user experience with text input controls in your designs.",
    videoId: "VCPGMjCW0is",
  },
  // Additional posts to demonstrate all types
  {
    ...
    excerpt:
      "Common pitfalls in web design and how to avoid them for better user engagement.",
  },
  // Type 4: Quote post
  {
    id: 5,
    ...
    category: "Branding",
    content:
      "A small river named Duden flows by their place & supplies it with the necessary regelialia. It is...",
  ...
  // Type 5: Link post
  {
    ...
    category: "Branding",
    content:
      "The rise of video marketing: engaging your audience with visual content",
    authorName: "Damien Cabral",
  },
  {
    id: 7,
    ...
    excerpt:
      "Maximize your e-commerce potential with these design strategies that drive conversions.",
  },
  {
    id: 8,
    type: "standard",
    ...
    title: "21 Web Design Mistakes to Avoid Right Now",
    excerpt:
      "Learn from common design errors to create more effective and user-friendly websites.",
  },
  {
    id: 9,
    type: "standard",
    ...
    excerpt:
      "Understanding the importance of return policies in e-commerce and customer satisfaction.",
  },
];
              ...
              <div className="tp-blog-masonry-thumb p-relative mb-30">
                <div className="tp-blog-masonry-thumb-video">
                  <button
                    ...
                    onClick={() => playVideo(post.videoId)}
                  >
                    <span>
                      <VideoPlayIconThree />
                    </span>
